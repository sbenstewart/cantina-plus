...
if($decision == "PHISHING")
    {
        $decision=exec("/mnt/neverdelete/projects/fyp/code/target\ identifier/scrape.py http://localhost:8050 /mnt/neverdelete/projects/fyp/code/target\ identifier/single-sites.json 1 /mnt/neverdelete/projects/fyp/code/target\ identifier/data 2>&1 ");
